...
config = {
    ...
    "encoder_model_path" : "charsiu/g2p_multilingual_byT5_small_100",
    "tokenizer_path": "google/byt5-small",
    "llmvox_checkpoint_path": "./CHECKPOINTS/ckpt_arabic.pt",
    
    # LLM settings
    "llm_checkpoint": "ALLaM-AI/ALLaM-7B-Instruct-preview",
    ...
    # Streaming settings
    "system_prompt": "أنت مساعد الذكاء الاصطناعي الذي يجيب على الأسئلة بطريقة مفيدة مع مراعاة القيم الثقافية المحلية ويقدم إجابات قصيرة.",
    ...
    # ASR settings
    "asr_model": "medium",                # Whisper model variant: tiny, base, small, medium, large
    ...
    "asr_default_language": "arabic",         # Default language for transcription
