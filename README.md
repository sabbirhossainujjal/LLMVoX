...
```
#### Custom models
You can easily create text-streamer for your custom model and integrate it with LLMVoX , refer to  `inference` to see the streamer template for LLMs ,VLMs and Multimodal LLMs.
